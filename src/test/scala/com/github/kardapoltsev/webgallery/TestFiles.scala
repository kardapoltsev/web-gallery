...
trait TestFiles {
  ...
  protected val dsc2845Metadata = ImageMetadata(Some("NIKON D7000"), Some(DateTime.parse("2014-05-10T16:44:41.000Z")))
  protected val dsc2845Image = Image(
    0, "DSC_2845.jpg", UUID.randomUUID().toString, User(123, "", 123, DateTime.now(DateTimeZone.UTC)), 123)
